...
JWT_SECRET_KEY = ''.join(random.choice(gen) for i in range(12))
...
SQLALCHEMY_DATABASE_URI = f'postgres://{user}:{passwd}@{host}:{port}/{database}'
# SQLALCHEMY_DATABASE_URI = 'postgres://dnitpesagem:postgres@localhost/dnit'  
